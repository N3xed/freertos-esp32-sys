...
#define configASSERT(a)                                                        \
  if (unlikely(!(a))) {                                                        \
      vPortPanic(__FILE__, strlen(__FILE__), __LINE__, __FUNCTION__, strlen(__FUNCTION__));                            \
  }
#endif
...
// ToDo: Make sure there is some space left for the app and main cpu when running
// outside of a thread.
#define configAPPLICATION_ALLOCATED_HEAP 1
#define configTOTAL_HEAP_SIZE (64 * 1024) //( ( size_t ) (64 * 1024) )
